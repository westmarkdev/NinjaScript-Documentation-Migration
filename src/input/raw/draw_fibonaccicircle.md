...
| &lt;&lt; [Click to Display Table of Contents](NT HelpGuide English.html?draw_fibonaccicircle.htm) &gt;&gt;
 [NinjaScript](ninjascript.htm) &gt; [Language Reference](language_reference_wip.htm) &gt; [Common](common.htm) &gt; [Drawing](drawing.htm) &gt;
Draw.FibonacciCircle() | [Previous page](extendedline.htm)
...
A [FibonacciCircle](fibonaccicircle.htm) object that represents the draw object.
