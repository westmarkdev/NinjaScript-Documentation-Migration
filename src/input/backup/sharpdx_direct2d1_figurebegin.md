...
| &lt;&lt; [Click to Display Table of Contents](NT HelpGuide English.html?sharpdx_direct2d1_figurebegin.htm) &gt;&gt;
 [NinjaScript](ninjascript.htm) &gt; [SharpDX SDK Reference](sharpdx_sdk_reference.htm) &gt; [SharpDX.Direct2D1](sharpdx_direct2d1.htm) &gt;
SharpDX.Direct2D1.FigureBegin | [Previous page](sharpdx_direct2d1_ellipse.htm)
...
Indicates whether a specific [GeometrySink](sharpdx_direct2d1_geometrysink.htm) figure is filled or hollow. 
