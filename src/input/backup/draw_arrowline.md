...
| &lt;&lt; [Click to Display Table of Contents](NT HelpGuide English.html?draw_arrowline.htm) &gt;&gt;
 [NinjaScript](ninjascript.htm) &gt; [Language Reference](language_reference_wip.htm) &gt; [Common](common.htm) &gt; [Drawing](drawing.htm) &gt;
Draw.ArrowLine() | [Previous page](arrowdown.htm)
...
An [ArrowLine](arrowline.htm) object that represents the draw object.
