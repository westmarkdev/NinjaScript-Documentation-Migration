...
| &lt;&lt; [Click to Display Table of Contents](NT HelpGuide English.html?sharpdx_direct2d1_geometrysink_addline.htm) &gt;&gt;
...
SharpDX.Direct2D1.GeometrySink.AddLine() | [Previous page](sharpdx_direct2d1_geometrysink_addarc.htm)
...
|  |  |
| --- | --- |
| vector2 | A [SharpDX.Vector2](sharpdx_vector2.htm) which represents the end point of the line to draw.  |
