...
| &lt;&lt; [Click to Display Table of Contents](NT HelpGuide English.html?draw_rectangle.htm) &gt;&gt;
 [NinjaScript](ninjascript.htm) &gt; [Language Reference](language_reference_wip.htm) &gt; [Common](common.htm) &gt; [Drawing](drawing.htm) &gt;
Draw.Rectangle() | [Previous page](ray.htm)
...
A [Rectangle](rectangle.htm) object that represents the draw object.
