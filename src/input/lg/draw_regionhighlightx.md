...
| &lt;&lt; [Click to Display Table of Contents](NT HelpGuide English.html?draw_regionhighlightx.htm) &gt;&gt;
 [NinjaScript](ninjascript.htm) &gt; [Language Reference](language_reference_wip.htm) &gt; [Common](common.htm) &gt; [Drawing](drawing.htm) &gt;
Draw.RegionHighlightX() | [Previous page](region.htm)
...
A [RegionHighlightX](regionhighlightx.htm) object that represents the draw object.
