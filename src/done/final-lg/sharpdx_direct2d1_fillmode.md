...
path: sharpdx_direct2d1_fillmode
---
...
- Use the FillMode enumeration when creating or modifying the fill mode of a [GeometrySink](sharpdx_direct2d1_geometrysink) with the [SetFillMode()](sharpdx_direct2d1_geometrysink_setfillmode) method.  
