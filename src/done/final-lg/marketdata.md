...
|----------------|--------------------------------------------------------------------------------------|
| Ask            | A [MarketDataEventArgs](marketdataeventargs) representing the ask price           |
| Bid            | A [MarketDataEventArgs](marketdataeventargs) representing the bid price           |
| DailyHigh      | A [MarketDataEventArgs](marketdataeventargs) representing the daily high          |
| DailyLow       | A [MarketDataEventArgs](marketdataeventargs) representing the daily low           |
| DailyVolume    | A [MarketDataEventArgs](marketdataeventargs) representing the daily volume        |
| Instrument     | An [Instrument](instrument) representing the instrument                             |
| Last           | A [MarketDataEventArgs](marketdataeventargs) representing the last price          |
| LastClose      | A [MarketDataEventArgs](marketdataeventargs) representing the last close          |
| Opening        | A [MarketDataEventArgs](marketdataeventargs) representing the opening price       |
| OpenInterest   | A [MarketDataEventArgs](marketdataeventargs) representing the open interest       |
| Settlement     | A [MarketDataEventArgs](marketdataeventargs) representing the settlement price    |
