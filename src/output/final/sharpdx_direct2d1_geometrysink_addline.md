...
pathName: /docs/desktop/sharpdx_direct2d1_geometrysink_addline
---
...
|  |  |
| --- | --- |
| vector2 | A [SharpDX.Vector2](/docs/desktop/sharpdx_vector2) which represents the end point of the line to draw. |
